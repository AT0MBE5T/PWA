...
export const translations: Record<Language, TranslationKeys> = {
    UA: {
        ...
        validation: {
            ...
            titleLength: 'Заголовок повинен бути коротший за 128 символів',
            ...
            contentLength: 'Вміст повинен бути коротшим за 1024 символів',
            descriptionRequired: 'Опис обов`язковий',
            descriptionLength: 'Опис повинен бути коротшим за 1024 символів',
        ...
        offers: {
            ...
            update: "Оновити",
            create: "Створити",
            searchStatementType: "Оберіть тип оголошення...",
            searchPropertyType: "Оберіть тип власності...",
            title: "Заголовок",
            ok: "Ок",
    ...
    EN: {
        ...
        validation: {
            ...
            titleLength: 'Title length must be less than 128 characters',
            selectStatementType: 'Please select a statement type',
            priceRequired: 'Price is required',
            priceBetween: 'Price must be between 1 and 99999999',
            contentRequired: 'Content is required',
            contentLength: 'Content length must be less than 1024 characters',
            descriptionRequired: 'Description is required',
            descriptionLength: 'Description length must be less than 1024 characters',
        ...
        offers: {
            ...
            update: "Update",
            create: "Create",
            searchStatementType: "Select statement type...",
            searchPropertyType: "Select property type...",
            title: "Title",
            ok: "Ok",
